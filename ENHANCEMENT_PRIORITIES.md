...
2. Resolve `_V1` file naming (housekeeping, low risk — do anytime, doesn't block anything)
...
2. **Resolve `_V1` file naming** — PROJECT_PROFILE_V1.md / COMMANDS_V1.md / RISKY_AREAS_V1.md — decide rename-back or keep, update references. (Housekeeping, low risk.)
