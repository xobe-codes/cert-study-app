/**
 * Hand-authored gold batch 8 — Network Access + IP Services domains 2 & 4.
 * Run: node scripts/generateGoldBatch8.mjs
 */
...
const BATCH8_IDS = Object.keys(HAND)
if (BATCH8_IDS.length !== 25) {
  console.error(`Expected 25 entries, got ${BATCH8_IDS.length}`)
  process.exit(1)
}
...
writeFileSync('src/answerReview/goldAnswerReviewsBatch8.js', lines.join('\n'))
console.error(`Wrote ${BATCH8_IDS.length} entries to goldAnswerReviewsBatch8.js`)
console.log(BATCH8_IDS.join('\n'))
