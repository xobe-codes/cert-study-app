...
export const OBJ_17 = {
  ...
  questions: [
    ...
    { id: '1.7-c-q6', concept: 'identify public', type: 'application', difficulty: 'easy', question: 'Which address is public (Internet-routable)?', choices: ['10.1.1.1', '172.16.1.1', '8.8.8.8', '192.168.1.1'], correctIndex: 2, explanation: '8.8.8.8 is a public Internet-routable address. TEST-NET ranges such as 198.51.100.0/24 are documentation space (RFC 5737) — not Internet-routable.', ckuIds: ['CKU-PUBLIC-PRIVATE'] },
