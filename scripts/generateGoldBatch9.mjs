/**
 * Hand-authored gold batch 9 — fundamentals/routing/automation domains 1, 3, 6.
 * Run: node scripts/generateGoldBatch9.mjs
 */
...
const BATCH9_IDS = Object.keys(HAND)
if (BATCH9_IDS.length !== 25) {
  console.error(`Expected 25 entries, got ${BATCH9_IDS.length}`)
  process.exit(1)
}
...
writeFileSync('src/answerReview/goldAnswerReviewsBatch9.js', lines.join('\n'))
console.error(`Wrote ${BATCH9_IDS.length} entries to goldAnswerReviewsBatch9.js`)
console.log(BATCH9_IDS.join('\n'))
