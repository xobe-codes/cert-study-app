#!/usr/bin/env python3
"""Gold batch 30 — 105 reviews: 4.9 stragglers, ACL 5.6, port security 5.7, AAA 5.8, automation 6.2–6.7. Run: python3 scripts/_genGoldBatch30.py"""
import json
...
assert len(HAND) == 105, f"Expected 105, got {len(HAND)}"
...
out = ROOT / "src/answerReview/goldAnswerReviewsBatch30.js"
