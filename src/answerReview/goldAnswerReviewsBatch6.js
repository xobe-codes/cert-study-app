...
export const BATCH6_GOLD = {
  'obj-2.6-depth-q2': {
    ...
    "examTip": "**FlexConnect** = branch APs switch locally when WAN to WLC fails."
  },
  'obj-2.7-depth-q3': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "AP uplink to switch = **802.1Q trunk** for mgmt + client VLANs."
  },
  'obj-2.8-depth-q2': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Clients associate but no IP → check **WLAN VLAN map + DHCP/DNS**."
  },
  'obj-3.6-depth-q2': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Static route missing → verify **next-hop reachable** and interface up."
  },
  'obj-3.6-depth-q3': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Valid route table ≠ ping success — **ACLs** can block ICMP."
  },
  'obj-3.6-depth-q4': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Flapping + CRC → **Layer 1/2** before blaming routing protocol."
  },
  'obj-3.6-depth-q5': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Local ping OK, remote fails → **default route / gateway** first."
  },
  'obj-3.6-depth-q6': {
    "correct": {
      "choiceIndex": 1,
  ...
  'obj-3.6-depth-q7': {
    ...
    "examTip": "No route install → fix **interface up/up** on egress path first."
  },
  'obj-4.10-depth-q3': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Always keep **local/out-of-band** access when cloud is down."
  },
  'obj-4.10-depth-q5': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Templates at scale beat **one-off CLI** on every box."
  },
  'obj-4.10-depth-q7': {
    "correct": {
      "choiceIndex": 0,
    ...
    "examTip": "Outage playbook: **console/local CLI** still works."
  },
  'obj-4.2-depth-q4': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Cross-device log correlation needs **NTP-synced clocks**."
  },
  'obj-4.3-depth-q3': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Name fails, IP works → **DNS server IP** from DHCP/static."
  },
  'obj-4.4-depth-q7': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "SNMP polling = manager-initiated **GET** on UDP 161."
  },
  'obj-4.5-depth-q2': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Wrong event order in logs → **NTP not synchronized**."
  },
  'obj-4.5-depth-q5': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Centralized syslog = audit + **faster MTTR**."
  },
  'obj-4.5-depth-q7': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Clock stuck at 1993 → set **NTP** or manual clock."
  },
  'obj-4.6-depth-q3': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "No DHCP offer → **relay, pool, server reachability** — in that order."
  },
  'obj-4.6-depth-q6': {
    "correct": {
      "choiceIndex": 0,
    ...
    "examTip": "Each routed client SVI needing DHCP needs its own **ip helper-address**."
  },
  'obj-4.6-depth-q7': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "**ip helper-address** goes on the **client-facing router/SVI**, not the server."
  },
  'obj-4.8-depth-q4': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Local login: **username + login local** on **line vty**."
  },
  'obj-4.8-depth-q6': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "SSH keys need **`ip domain-name`** before `crypto key generate rsa`."
  },
  'obj-5.10-depth-q6': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Untrusted path traffic → **encrypt** (VPN/IPsec class)."
  },
  'obj-5.11-depth-q3': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "**DMZ** = exposed services with controlled inbound from Internet."
  },
  'obj-5.11-depth-q6': {
    "correct": {
      "choiceIndex": 1,
  ...
  'obj-5.2-depth-q3': {
    ...
    "examTip": "Security program = **people + process + technology**."
  },
  'obj-5.3-depth-q3': {
    "correct": {
      "choiceIndex": 0,
    ...
    "examTip": "**login local** does not encrypt — use **SSH** on vty."
  },
  'obj-5.3-depth-q7': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Enable SSH only after **crypto key** exists."
  },
  'obj-5.4-depth-q5': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Central creds/policy → **TACACS+/RADIUS** (AAA servers)."
  },
  'obj-5.6-depth-q5': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Rogue DHCP → **DHCP snooping** on access ports."
  },
  'obj-5.8-depth-q7': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Guest WLAN → **isolated VLAN**, not corporate flat."
  },
  'obj-6.1-depth-q2': {
    "correct": {
      "choiceIndex": 0,
    ...
    "examTip": "Automation shifts work to **templates/code + verification**."
  },
  'obj-6.2-depth-q4': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Traditional = **per-device CLI** control plane."
  },
  'obj-6.2-depth-q7': {
    "correct": {
      "choiceIndex": 0,
    ...
    "examTip": "Real networks mix **controller intent + box verification**."
  },
  'obj-6.3-depth-q5': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Apps/orchestration talk **northbound** to the controller."
  },
  'obj-6.4-depth-q4': {
    "correct": {
      "choiceIndex": 0,
    ...
    "examTip": "DNA Center augments — does not remove **local CLI troubleshooting**."
  },
  'obj-6.4-depth-q6': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Traditional ops pain = **repetitive CLI** at scale."
  },
  'obj-6.6-depth-q7': {
    "correct": {
      "choiceIndex": 1,
    ...
    "examTip": "Repeatable config → **Ansible/playbooks** (desired state)."
  },
  '3.6-legacy-q001': {
    "correct": {
      "choiceIndex": 1,
  ...
  '4.9-en-q2': {
    ...
    "examTip": "Sensitive IOS copy → **SCP/SFTP**, not cleartext TFTP."
  },
  '5.11-legacy-q005': {
    "correct": {
      "choiceIndex": 1,
  ...
  '5.9-en-q3': {
    ...
    "examTip": "Wrong client subnet after join → **SSID → VLAN interface** mapping."
  },
}
