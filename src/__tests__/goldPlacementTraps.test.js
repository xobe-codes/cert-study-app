...
const ALL_PLACEMENT_TRAP_GOLD = { ...PLACEMENT_TRAP_GOLD, ...PLACEMENT_TRAP_GOLD_BATCH2 }
...
describe('goldAnswerReviewsPlacementTraps', () => {
  it('polishes every placement blueprint trap stem', () => {
    ...
    expect(trapIds).toHaveLength(43)
    expect(Object.keys(ALL_PLACEMENT_TRAP_GOLD)).toHaveLength(43)
