/**
 * Hand-authored gold batch 11 — Wireless 2.6–2.8 + DHCP/DNS 4.3–4.4.
 * Run: node scripts/generateGoldBatch11.mjs
 */
...
const BATCH11_IDS = Object.keys(HAND)
if (BATCH11_IDS.length !== 25) {
  console.error(`Expected 25 entries, got ${BATCH11_IDS.length}`)
  process.exit(1)
}
...
writeFileSync('src/answerReview/goldAnswerReviewsBatch11.js', lines.join('\n'))
console.error(`Wrote ${BATCH11_IDS.length} entries to goldAnswerReviewsBatch11.js`)
console.log(BATCH11_IDS.join('\n'))
