...
import { validateQuestionAnswerReview, isFallbackExplanation } from '../src/answerReview/answerReviewQuality.js'
...
if (errors.length) {
  console.error(`✗ Answer review validation failed (${errors.length} issues, ${fallback} fallback slots):`)
  errors.slice(0, 40).forEach(e => console.error('  -', e))
  if (errors.length > 40) console.error(`  … and ${errors.length - 40} more`)
  process.exit(1)
}

console.log(`✓ Answer reviews valid — ${total} questions, 0 fallback explanations`)
